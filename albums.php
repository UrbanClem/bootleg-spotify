            ...
            <?php else: ?>
                <div class="col-12">
                    <div class="alert alert-info text-center py-4">
                        ...
                        <p class="mb-0">Comienza agregando el primer álbum a tu biblioteca musical.</p>
                        <a href="add_album.php" class="btn mt-3" style="background: #1db954; color: white;">
                            <i class="fas fa-plus me-2"></i>Agregar Primer Álbum
                        </a>
                    </div>
                </div>
            <?php endif; ?>
